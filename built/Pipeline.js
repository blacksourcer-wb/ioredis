...
Pipeline.prototype.exec = function (callback) {
    ...
    if (this.isCluster) {
        ...
        for (let i = 0; i < this._queue.length; i++) {
            ...
            const isCommandReadOnly = this._queue[i].isReadOnly ||
                ((0, commands_1.exists)(this._queue[i].name) && (0, commands_1.hasFlag)(this._queue[i].name, "readonly"));
            isPipelineReadOnly && (isPipelineReadOnly = isCommandReadOnly);
        }
